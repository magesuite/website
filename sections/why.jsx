...
import TabSwitchAnimation from "../components/tab-switch-animation";
...
export default class Why extends Component {
    ...
    renderTabContent() {
        switch (this.state.tab) {
            case 'cms':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-cms" widthDesktop="60%"/>)}>
            ...
            case 'perf':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-performance" widthDesktop="80%"/>)}>
            ...
            case 'security':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-security" widthDesktop="50%"/>)}>
            ...
            case 'search':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-search" widthDesktop="60%"/>)}>
            ...
            case 'marketing':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-marketing" widthDesktop="60%"/>)}>
            ...
            case 'ux':
                return (
                    <TextPicture picture={(<PictureVectorpng image="g-feature-ux" widthDesktop="80%"/>)}>
