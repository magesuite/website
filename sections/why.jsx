    ...
    render() {
        ...
        return (
            <Article className="limited-width" id="why">
                <Headline as="h2" centered>What is MageSuite?</Headline>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">Content Constructor</Headline>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">High Performance</Headline>
                    <Paragraph size="20" distance>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">Security &amp; GDPR</Headline>
                    <Paragraph size="20" distance>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">Search Engine</Headline>
                    <Paragraph size="20" distance>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">Marketing</Headline>
                    <Paragraph size="20" distance>
                ...
                <TextPicture picture={(
                    ...
                    <Headline as="h3" size="20">User Experience</Headline>
                    <Paragraph size="20" distance>
